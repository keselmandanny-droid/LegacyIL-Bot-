...
export default {
    ...
    .setName("app-admin")
    .setDescription("🎯 ניהול מערכת המועמדויות - הגדרה, סקירה והצגת בקשות")
    .setDefaultMemberPermissions(PermissionFlagsBits.ManageGuild)
    .addSubcommand((subcommand) =>
        subcommand
            .setName("setup")
            .setDescription("⚙️ הגדרת מועמדות חדשה לתפקיד בשרת")
    )
    .addSubcommand((subcommand) =>
        subcommand
            .setName("review")
            .setDescription("✅ אישור או דחיית מועמדות")
            .addStringOption((option) =>
                option
                    .setName("id")
                    .setDescription("מזהה המועמדות לסקירה")
                    .setRequired(true),
            ),
    )
    .addSubcommand((subcommand) =>
        subcommand
            .setName("list")
            .setDescription("📋 הצגת כל המועמדויות המוגשות")
            .addStringOption((option) =>
                option
                    .setName("status")
            ...
            .addNumberOption((option) =>
                option
                    .setName("limit")
                    .setDescription(
                        "כמות מקסימלית להצגה (ברירת מחדל: 10)",
                    )
                    .setMinValue(1)
                    .setMaxValue(25),
            ),
    ...
    .addSubcommand((subcommand) =>
        subcommand
            .setName("dashboard")
            .setDescription("🎛️ פתיחת לוח הבקרה להגדרת מערכת המועמדויות")
            .addStringOption((option) =>
                option
                    .setName("application")
                    .setDescription("בחר מועמדות להגדרה")
                    .setRequired(false)
